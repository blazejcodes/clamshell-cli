...
/**
 * This class provides a mock context useful for testing. It avoids the
 * ceremonial setup required by the framework but generates all necessary
 * classes for a fully functional Context instance.
 * 
...
public final class MockContext implements Context {
	...
	public Map<String, Command> mapCommands(List<Command> commands) {
		...
		Map<String, Command> mappedCommands = new HashMap<>();
		for (Command command : commands) {
			mappedCommands.put(command.getDescriptor().getName(), command);
		}
