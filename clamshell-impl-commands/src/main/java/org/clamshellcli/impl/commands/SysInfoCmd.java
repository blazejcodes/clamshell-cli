...
/**
 * This is a Command implementation that returns runtime system information. The
 * implemented command has the command-line format of:
 * 
 * <pre>
...
public class SysInfoCmd implements Command {
	...
	private class SysInfoDescriptor implements Command.Descriptor {
		...
		public String getUsage() {
			...
			result.append(Configurator.VALUE_LINE_SEP).append("sysinfo [options]").append(Configurator.VALUE_LINE_SEP);
		...
		public Map<String, String> getArguments() {
			if (commander == null)
				commander = new JCommander(new SysInfoParams());
